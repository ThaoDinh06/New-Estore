...
def search(request):
    ...
    if request.GET.get('from_price'):
        ...
        # http://127.0.0.1:8000/subcategory/0/?from_price=10000&to_price=1000000&product_name=ủi
        # /subcategory/0/?from_price=10000&to_price=1000000&product_name=%E1%BB%A7i
        base_url = reverse('store:product_list', kwargs={'pk': 0})
        query_string = urlencode({
            'from_price': round(from_price),
            'to_price': round(to_price),
            'product_name': product_name,
        })
